      ...
      <div className="flex justify-between px-2 py-2 items-center border-b border-gray-300 relative">
        ...
        <div className="flex items-center">
          ...
          <div className="flex gap-1">
            <p className="text-sm md:text-lg font-semibold text-[#FF2351]">Maju</p>
            <p className="text-sm md:text-lg font-light">Kiri</p>
          </div>
        </div>
        ...
        <div className={`flex-col md:flex-row gap-5 absolute md:static bg-white top-16 left-0 right-0 px-5 py-3 md:p-0 md:flex ${menuOpen ? 'flex border-y mt-2 border-gray-200 z-10' : 'hidden'} md:flex`}>
          <div className="flex gap-1 items-center">
            ...
            <p className="text-sm md:text-lg font-light text-[#000]">Menu</p>
          </div>
          <div className="flex gap-1 items-center">
            ...
            <p className="text-sm md:text-lg font-light text-[#000]">History</p>
          </div>
          <div className="flex gap-1 items-center">
            ...
            <p className="text-sm md:text-lg font-light text-[#000]">Member</p>
          </div>
        </div>
        ...
        <div className="md:flex hidden gap-1 items-centern ">
          ...
          <div className="flex-col">
            <p className="text-sm md:text-lg font-light">Ari eka saputra</p>
            <p className="text-xs md:text-sm font-semibold text-[#FF2351]">Cashier</p>
          </div>
        </div>
